...
draw_text(4,4+y_off,"x:" + string(o_player.x) + ". y:" + string(o_player.y));
draw_text(4,12+y_off,"grid_x:" + string(o_player.grid_x) + ". grid_y:" + string(o_player.grid_y));
var c = c_white;
...
draw_text_color(4,20+y_off,"p_state." + str,c,c,c,c,1);
str = "";
