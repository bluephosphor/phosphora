...
attack_frames[0]	= [9,10,11,12,13,14];													   fill_frametype(attack_frames[0],frametype.block);
hitstun_frames		= [1];																	   //
block_frames		= [9];																	   //
...
fill_frametype([12,13,14],frametype.vulnerable);			 //jump startup frames
fill_frametype([31,32,33,34,35,36,37],frametype.vulnerable); //jump cooldown frames
