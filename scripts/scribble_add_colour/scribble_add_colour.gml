...
{
    debug_log_add("Scribble: WARNING! Colour name \"" + _name + "\" has already been defined as an effect" );
    exit;
}
...
{
    debug_log_add("Scribble: WARNING! Overwriting colour \"" + _name + "\" (" + string(colour_get_red(_old_colour)) + "," + string(colour_get_green(_old_colour)) + "," + string(colour_get_blue(_old_colour)) + ", u32=" + string(_old_colour) + ")");
}

global.__scribble_colours[? _name ] = _colour;

if (SCRIBBLE_VERBOSE) debug_log_add("Scribble: Added colour \"" + _name + "\" as " + string(colour_get_red(_colour)) + "," + string(colour_get_green(_colour)) + "," + string(colour_get_blue(_colour)) + ", u32=" + string(_colour));