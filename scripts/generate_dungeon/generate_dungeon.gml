function generate_dungeon() {
	...
	instance_create_layer(exit_x * CELL_WIDTH,_controller_y * CELL_HEIGHT,"Instances", obj_exit);
	...
	if (chest_index == 0){
		place_x = (_controller_x + -_x_direction) * CELL_WIDTH + 16;
		place_y = (_controller_y  + - _y_direction) * CELL_HEIGHT + 16;
